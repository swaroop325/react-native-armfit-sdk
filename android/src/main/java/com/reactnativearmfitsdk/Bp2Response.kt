...
import com.reactnativearmfitsdk.utils.toInt
...
object Bp2Response {
  ...
  class DataEcgResult(var bytes: ByteArray) {
    ...
    fun getResultStr() = when(result) {
      0x00000000 -> "be_ecg_diagnosis_regular"
      0x00000001 -> "be_ecg_diagnosis_fast_hr"
      0x00000002 -> "be_ecg_diagnosis_slow_hr"
      -1 -> "be_ecg_diagnosis_poor_signal"
      -2 -> "be_device_ecg_result_FFFFFFFE"
      -3 -> "be_device_ecg_result_FFFFFFFD"
      else -> "ecg_diagnosis_irregular"
    }
